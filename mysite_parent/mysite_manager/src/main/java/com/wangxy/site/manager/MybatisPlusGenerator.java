...
public class MybatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/tensquare_article?useUnicode=true&useSSL=false&characterEncoding=utf8");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                ...
                return projectPath + module+ "/src/main/resources/mapper/" + pc.getModuleName()
        ...
        */
        ...
        //strategy.setSuperEntityClass("com.wangxy.site.common.BaseEntity");
